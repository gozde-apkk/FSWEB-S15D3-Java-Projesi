...
public class WordCounter {
    public static void main(String[] args) {
        ...
        Set<String> keyWords = wordMap.keySet();
        for (String keyWord: keyWords){
            System.out.println("Key:" + keyWord + "Value:" + wordMap.get(keyWord));
        }
